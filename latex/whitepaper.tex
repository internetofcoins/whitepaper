...
\subsubsubsection{Decentralized escrow}
...
\subsubsubsection{Multisignature approach}

\subsubsubsubsection{Publish target address}
...
\subsubsubsubsection{Release access keys}
